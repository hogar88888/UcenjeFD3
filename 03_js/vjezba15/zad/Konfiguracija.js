...
class Konfiguracija extends EdunovaObrada {
    ...
    get projekt() { return this.#mjesto; }
    set projekt(v) { this.#mjesto = v; }
    ...
    provjeriValjanost(el) {
        ...
        this.#mjesto = izvrsiProvjeru(Pomocno.provjeriString, el.projekt, 4, 'Mjesto projekta minimalno 3 znaka.');
        if(el.mjesto.value.indexOf(' ')>-1){
            super.dodajGresku({
                element: el.mjesto, 
                greska: 'Mjesto projekta ne smije imati razmak'
